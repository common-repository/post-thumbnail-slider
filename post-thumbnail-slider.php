...
function pts_slider_cpt() {
	...
	$labels = [
		...
		"add_new_item"  => __("Add New Slider", "post-thumbnail-slider"),
	];
	...
	?>
		<div class="pts_admin_page">
			<div class="pts_header">
				<a href="https://pts.webackstop.com/demos" target="_blank"><?php echo __( 'See Demo', 'post-thumbnail-slider' ); ?></a>
				<a href="https://webackstop.com/downloads/post-thumbnail-slider-pro/" target="_blank"><?php echo __( 'Get Pro', 'post-thumbnail-slider' ); ?></a>
			</div>
			<div class="pts_support_blocks">
				<div class="single-block">
					...
					<?php echo '<a href="https://webackstop.com/submit-ticket/" target="_blank">'.__('Create Support Ticket','post-thumbnail-slider').'</a>'; ?>
					</div>
				</div>
				<div class="single-block">
					<div class="icon">
				...
				<div class="single-block">
					...
					<?php echo '<a href="https://webackstop.com/place-order/" target="_blank">'.__('Contact Us','post-thumbnail-slider').'</a>'; ?>
					</div>
				</div>
			</div>
		</div>
